...
<%@ page import="com.google.gwt.decisiontree.model.Greeting" %>
<%@ page import="com.google.gwt.decisiontree.model.Guestbook" %>
...
<%
    // Create the correct Ancestor key
      Key<Guestbook> theBook = Key.create(Guestbook.class, problemName);
...
%>
<p>Guestbook '${fn:escapeXml(problemName)}' has no messages.</p>
<%
    } else {
%>
<p>Messages in Guestbook '${fn:escapeXml(problemName)}'.</p>
<%
...
<form action="/welcomepage.jsp" method="get">
	...
	<br/>
    <input type="submit" value="Switch Problem List"/></div>
</form>

<a href="/insertattribute.jsp"> Insert attribute  </a>
<p>
<a href="/inducedecisiontree.jsp"> Induce Decision Tree </a>
