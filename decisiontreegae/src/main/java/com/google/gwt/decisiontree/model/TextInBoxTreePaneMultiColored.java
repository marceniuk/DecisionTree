...
public class TextInBoxTreePaneMultiColored extends javax.swing.JComponent
{
    ...
    public TextInBoxTreePaneMultiColored(TreeLayout treeLayout)
    {
        ...
        java.awt.Dimension size = new java.awt.Dimension(treeLayout.getBounds().getBounds().getSize().width,treeLayout.getBounds().getBounds().getSize().height);
